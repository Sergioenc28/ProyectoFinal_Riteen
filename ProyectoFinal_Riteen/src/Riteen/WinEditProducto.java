...
public class WinEditProducto extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        verProductoEdtBoton = new javax.swing.JButton();
        ...
        verProductoEdtBoton.setFont(new java.awt.Font("Times New Roman", 0, 14)); // NOI18N
        verProductoEdtBoton.setText("Ver todos los Productos");
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(layout.createSequentialGroup()
                        ...
                        .add(productoEdtText, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 262, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.UNRELATED)
                        .add(buscarProductoBoton))
                    .add(layout.createSequentialGroup()
                        .add(68, 68, 68)
                        .add(jLabel1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 269, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE))
                    .add(verProductoEdtBoton))
                .add(32, 32, 32))
            .add(layout.createSequentialGroup()
                .add(152, 152, 152)
                .add(guardarProductoEdt)
                .add(30, 30, 30)
                .add(cancelarProductoEdt)
        ...
        layout.setVerticalGroup(
            ...
            .add(layout.createSequentialGroup()
                ...
                .add(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.BASELINE)
                    .add(productoEdtText, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                    .add(jLabel2)
                    .add(buscarProductoBoton))
                .add(18, 18, 18)
                .add(verProductoEdtBoton)
    ...
    private javax.swing.JButton verProductoEdtBoton;
